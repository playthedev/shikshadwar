...
import { cartTotal, productCart } from "@/lib/cart-store";

/** Checks out only what's in `productCart` — never a Meet Our Stars sponsorship. */
    ...
    <div className="grid gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
      ...
      <div className="rounded-(--radius) border border-border bg-surface p-6 md:p-8">
        <DonateForm
          ...
          onSuccess={productCart.clearCart}
        />
      </div>
    </div>
  );
