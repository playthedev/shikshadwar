...
/**
 * Email-only capture, set on a light paper background —
...
export function NewsletterSignup() {
  ...
  return (
    <section className="grain-overlay bg-paper py-[clamp(4rem,8vw,6rem)]">
      <Container>
            ...
            {result?.status === "success" ? (
              ...
              >
                ...
                <Input
                  ...
                  autoComplete="email"
                  className="h-12 flex-1 border-ink/20 bg-ink/5 text-ink placeholder:text-ink/40"
                  value={values.email}
